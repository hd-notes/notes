...
** Transformation
   ...
   für $(B_k)_{k ∈ ℕ} ∈ Σ_Y$, paarweise disjunkte $⇒ f^{-1}(B_k) =: A_k$ ebenfalls eine Folge paarweise disjunkter Mengenu und
   ...
   Also $(f \ast μ)(B^C) = μ(A^C)$. Für das Integal nehmen wir zuerst einfache Funktion
   \begin{align*}
