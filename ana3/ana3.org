...
* Grundlagen der Maß- und Integrationstheorie
  ...
  *Notation*: Zu $(A_k)_{k ∈ ℕ} ⊂ X$ schreiben wir
  ...
  Sei $X$ ein topologischer Raum und $A ⊂ X$. Dann nennt man $A$ kompakt, wenn *jede* offene Überdeckung von $A$ eine *endliche* Teilüberdeckung besitzt.
  Das beutet:
  ...
  *Konstruktion von Maßen* \\
  ...
  #+end_defn
  #+begin_remark latex
  1. Ein Dynkin-System it abgeschlossen bezüglich Mengensubtraktion:
