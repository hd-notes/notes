...
** Integration
   ...
   andererseits
   \[∫_{ℝ} f_k \d x = 1, f_k = k χ_{(0,\frac{1}{k})} \text{ und } f_k = \frac{1}{k} χ_{(0,k)}\]
   #+end_remark
   #+begin_defn latex
...
* Fourier-Transformation
  ...
  \[\hat f(p) = \frac{1}{(2π)^{n/2}} ∫_{ℝ} e^{-i\braket{p,x}} f(x) \d λ^n(x) \qquad p ∈ ℝ^n\]
