	   ...
	   - mit templates reicht eine Implementation
		 ...
		 - Benutzug:
		   ...
		   - kombiniert man templates mit Overloading, wird die ausprogrammierte Variante vom Compiler bevorzugt.
			 Komplizierte Fälle (Argument teilweise Template, teilweise hard_coded) \Rightarrow für Fortgeschrittene
		 ...
		 - Bespiel 3: checken, ob Container sortiert ist
		   ...
		   // == std::is_sorted
		   #+END_SRC
		 - Bemerkung1: Complier-Fehlermeldungen bei Template-Code sind oft schwer zu interpretieren, \Rightarrow Erfahrug nötig aber: Compiler werden darin immer besser, besonders clang-comiler
