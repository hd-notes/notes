* Basis und Dimension
  ...
  3. $\implies$ 4.: Wir setzte 3. vorraus, das heißt für jedes $v\in V$ existieren eindeutig bestimmt $\lambda_1, \ldots, \lambda_n \in K$ mit $v = \lambda_1 v_1 + \ldots + \lambda_n v_n$. \\
  ...
  #+begin_proof latex
  1.
	 - $V$ endlich erzeugt $\implies$ ex existiert eine endliche Basis $(v_1, \ldots, v_r)$ von $V$, sei $(w_i)_{i\in I}$ beliebige Basis von $V$. Falls $I$ unendlich, dann existiert $i_1, \ldots, i_{r + 1} \in I$, dosass $(w_{i_1} + \ldots + w_{i_{r + 1}})$
  ...
  - Offenbar gilt $V$ endlich erzeugt $\iff$ $V$ endlichdimensional
  #+end_note
