* Euklidische Ringe
  ...
  *Ziel:* Klassifikation von Matrizen aus $M(m × n, R), R$ Euklidischer Ring bis auf Äquivalenz.
  ...
  #+end_remdef
  #+begin_proof latex
  1. Existenz: $K[t]$ ist ein Euklidischer Ring. Fundamentalteilersatz $⇒ ∃ \tilde c_1, \dots, \tilde c_r ∈ K[t]$:
  ...
  2. $K[t]$ Hauptidealring $⇒ \Fit_l(P_A), l = 1, \dots, n$ sind Hauptideale und nach 27.16 ist $\Fit_l(P_A) = (c_1(A) · \dots · c_l(A))$
	 # TODO
  #+end_proof
  #+begin_conc latex
