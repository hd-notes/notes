...
* Moduln über Hauptidealringen
  ...
  *Eindeutigkeitsaussage: Setze $T' := \Lin((x_1, \dots, x_s))$
  ...
  2. Wir betrachten die Abbildung
	 ...
	 $s = \Rans(M)$ eindeutig bestimmt. $⇒$ Anzahl der Einheiten unter $c_1, \dots, c_s$ eindeutig bestimmt, Einheiten unter $c_1, \dots, c_s$ sind eindeutig bis aus Asoziiertheit.
  #+end_proof
  #+begin_conc latex
