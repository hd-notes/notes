...
*** Strömung durch ein Rohr mit kreisförmigen Querschnitt (Hagen-Poiseuille)
	...
	\end{align*}
	#+begin_ex latex
	Für ein rundes Rohr mit Radis $R$ gilt:
...
*** Strömungswiderstand von glatten Körper
	...
	1. Laminare Strömung: $F_N \sim v$
	   #+ATTR_LATEX: :options [Gesetz von Stokes]
 	   #+begin_defn latex
	   Strömungswiederstand einer Kugel
	   \[F_W = F_R = 6\pi \eta r v\]
	   #+end_defn
	   Gesetz von Stokes wichtig für die gesmate Naturwissenschaft! (Sedimentation, Staubteilchen, Milikanversuch...)
	2. Turbulente Strömung: $F_N \sim v^2$
	   Qualitativer Beweis: Teilchen, die mit der Strömungsgeschwindigketi $\v v_K$ auf den
	   ...
	   überführt. Deren Geschwindigketi entspricht ungefähr der Strömungsgeschwindigkeit $v_k$,
	   weshalb der Druck hinter dem Körper wieder auf dem altn Druck $p_0$ absinkt. Die
