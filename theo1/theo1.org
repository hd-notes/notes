...
#+LATEX_HEADER: }
#+LATEX_HEADER: \reneqcommand*{\proofname}{Beweis}
...
** Konservative Kräfte und Energieerhaltung
   \begin{defn}[Gradient]
   Gradient von $V$:
   \[\v\nabla \equiv \left(\frac{\parital V}{\partial x^1}, \frac{\parital V}{\partial x^2}, \frac{\parital V}{\partial x^3}\right)\]
   $\v\nabla V$ ist gute Schreibweise, weil $\v\nabla$ ein vektorwertiger Differentialoperator ist:
   \[\v\nabla = \left(\frac{\parital}{\partial x^1}, \frac{\parital}{\partial x^2}, \frac{\parital}{\partial x^3}\right)\]
   \end{def}
