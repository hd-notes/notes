...
** Affinier Raum
   ...
   Besser: Definition des *affinen Raumes*: Gegeben sein Menge $A$, ein Vektorraum $V$ un eine Abbildung $A\times A \to V, (P, Q) \mapsto \v{PQ}$
...
** Zusammenfassung:
   ...
   - Invarianz der Dynamik prüfen beziehungsweise forder (Spielregeln) (Newtonsches Grundgesetz)
