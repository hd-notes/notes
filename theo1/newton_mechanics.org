...
*** System von Dgl.
	...
	Anfangsbedingungen: $(x_0,\v{y}_0)$ \rightarrow $n+1$ Parameter. Einer davon entspricht der Verschiebung entlang ein und derselben Lösung \Rightarrow allgemeine Lösung hat $(n + 1) - 1 = n$ Parameter oder Integrationskonstanten.
...
**** Beispiel
	 ...
	 \Rightarrow System von $p$ Dgl 1. Ordung; allgemeine Lösung hat $p$ Parameter
