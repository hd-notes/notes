...
** Magnetische Induktion
   Beobachtungen
   - Bewegte Leiterschleife im Magnetfeld resultiert in Induktion und Spannugsstöhen
   - Vorzeichen abhängig von Bewegungsrischtung und Richtung des Magnetfelds
   - Mehrere Windungen (beziehungsweise gröhere Fläche) $\to$ höhere Spannungen
