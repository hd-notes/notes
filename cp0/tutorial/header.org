...
#+LATEX_HEADER: \SetupFloatingEnvironment{listing}{placement=htp}
#+LATEX_HEADER: \usepackage{polyglossia}
#+LATEX_HEADER: \setdefaultlanguage{english}
#+LATEX_HEADER: \usepackage{algorithm2e, siunitx, stmaryrd, etoolbox, wasysym, xparse, stackengine, tikz, xcolor, pgfplots, makecell, tikz-qtree, enumitem, microtype, scalerel, tikz-uml, faktor, braket, bbm, caption}
...
#+LATEX_HEADER: \setminted[]{breaklines=true,linenos,frame=lines,mathescape=true,autogobble}
#+LATEX_HEADER: \renewenvironment{listing}{\captionsetup{type=listing}}{}
...
#+LATEX_HEADER:	\newcommand{\Vastr}{\mathclose\Vast}
#+LATEX_HEADER:	\makeatother
#+LATEX_HEADER:	\setcounter{topnumber}{2}
#+LATEX_HEADER:	\setcounter{bottomnumber}{2}
#+LATEX_HEADER:	\setcounter{totalnumber}{4}
#+LATEX_HEADER:	\renewcommand{\topfraction}{0.95}
#+LATEX_HEADER:	\renewcommand{\bottomfraction}{0.95}
#+LATEX_HEADER:	\renewcommand{\textfraction}{0.05}
#+LATEX_HEADER:	\renewcommand{\floatpagefraction}{1.0}
#+LATEX_HEADER:	\setlength{\floatsep}{5pt plus 2pt minus 2pt}
#+LATEX_HEADER:	\setlength{\textfloatsep}{5pt plus 2pt minus 2pt}
#+LATEX_HEADER:	\setlength{\intextsep}{5pt plus 2pt minus 2pt}
